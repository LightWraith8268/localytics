...
function getTemplateDefinitions() {
  ...
  return [
    ...
    // TIME COMPARISONS
    { name: "[WINDSOR] Last 7 Days", reportType: "item", startDate: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString().split('T')[0], endDate: "", itemFilter: "", clientFilter: "", staffFilter: "Windsor Stagg", categoryFilter: "", columns: { item: true, quantity: true, revenue: true, cost: true, profit: true, margin: true, orders: false, date: false } },
    { name: "[WINDSOR] Last 90 Days", reportType: "item", startDate: last90Days, endDate: "", itemFilter: "", clientFilter: "", staffFilter: "Windsor Stagg", categoryFilter: "", columns: { item: true, quantity: true, revenue: true, cost: true, profit: true, margin: true, orders: false, date: false } },
    { name: "[WINDSOR] Week-over-Week Comparison", reportType: "item", startDate: new Date(Date.now() - 14 * 24 * 60 * 60 * 1000).toISOString().split('T')[0], endDate: "", itemFilter: "", clientFilter: "", staffFilter: "Windsor Stagg", categoryFilter: "", columns: { item: true, quantity: true, revenue: true, cost: true, profit: true, margin: true, orders: false, date: false } },
    { name: "[WINDSOR] Month-over-Month Growth", reportType: "item", startDate: new Date(Date.now() - 60 * 24 * 60 * 60 * 1000).toISOString().split('T')[0], endDate: "", itemFilter: "", clientFilter: "", staffFilter: "Windsor Stagg", categoryFilter: "", columns: { item: true, quantity: true, revenue: true, cost: true, profit: true, margin: true, orders: false, date: false } },

    // PROFITABILITY ANALYSIS
    { name: "[WINDSOR] Low Margin Items", reportType: "item", startDate: "", endDate: "", itemFilter: "", clientFilter: "", staffFilter: "Windsor Stagg", categoryFilter: "", sortBy: "margin", columns: { item: true, quantity: true, revenue: true, cost: true, profit: true, margin: true, orders: false, date: false } },
    { name: "[WINDSOR] Most Profitable Items (by Total Profit)", reportType: "item", startDate: "", endDate: "", itemFilter: "", clientFilter: "", staffFilter: "Windsor Stagg", categoryFilter: "", sortBy: "profit", limit: "40", columns: { item: true, quantity: true, revenue: true, cost: true, profit: true, margin: true, orders: false, date: false } },
    { name: "[WINDSOR] Profitability Analysis (All Items)", reportType: "item", startDate: "", endDate: "", itemFilter: "", clientFilter: "", staffFilter: "Windsor Stagg", categoryFilter: "", columns: { item: true, quantity: true, revenue: true, cost: true, profit: true, margin: true, orders: false, date: false } },

    // SEASONAL PERFORMANCE
    { name: "[WINDSOR] Spring Sales (Mar-May)", reportType: "item", startDate: `${currentYear}-03-01`, endDate: `${currentYear}-05-31`, itemFilter: "", clientFilter: "", staffFilter: "Windsor Stagg", categoryFilter: "", columns: { item: true, quantity: true, revenue: true, cost: true, profit: true, margin: true, orders: false, date: false } },
    { name: "[WINDSOR] Summer Sales (Jun-Aug)", reportType: "item", startDate: `${currentYear}-06-01`, endDate: `${currentYear}-08-31`, itemFilter: "", clientFilter: "", staffFilter: "Windsor Stagg", categoryFilter: "", columns: { item: true, quantity: true, revenue: true, cost: true, profit: true, margin: true, orders: false, date: false } },
    { name: "[WINDSOR] Fall Sales (Sep-Nov)", reportType: "item", startDate: `${currentYear}-09-01`, endDate: `${currentYear}-11-30`, itemFilter: "", clientFilter: "", staffFilter: "Windsor Stagg", categoryFilter: "", columns: { item: true, quantity: true, revenue: true, cost: true, profit: true, margin: true, orders: false, date: false } },
    { name: "[WINDSOR] Winter Sales (Dec-Feb)", reportType: "item", startDate: `${currentYear}-12-01`, endDate: `${currentYear + 1}-02-28`, itemFilter: "", clientFilter: "", staffFilter: "Windsor Stagg", categoryFilter: "", columns: { item: true, quantity: true, revenue: true, cost: true, profit: true, margin: true, orders: false, date: false } },

    // SPECIFIC PRODUCT CATEGORIES
    { name: "[WINDSOR] Mulch Sales", reportType: "item", startDate: "", endDate: "", itemFilter: "mulch", clientFilter: "", staffFilter: "Windsor Stagg", categoryFilter: "", columns: { item: true, quantity: true, revenue: true, cost: true, profit: true, margin: true, orders: false, date: false } },
    { name: "[WINDSOR] Stone/Gravel Sales", reportType: "item", startDate: "", endDate: "", itemFilter: "stone, gravel, rock", clientFilter: "", staffFilter: "Windsor Stagg", categoryFilter: "", columns: { item: true, quantity: true, revenue: true, cost: true, profit: true, margin: true, orders: false, date: false } },
    { name: "[WINDSOR] Soil/Topsoil Sales", reportType: "item", startDate: "", endDate: "", itemFilter: "soil, topsoil, dirt", clientFilter: "", staffFilter: "Windsor Stagg", categoryFilter: "", columns: { item: true, quantity: true, revenue: true, cost: true, profit: true, margin: true, orders: false, date: false } },

    // ADVANCED METRICS
    { name: "[WINDSOR] Fast-Moving Items (High Quantity)", reportType: "item", startDate: "", endDate: "", itemFilter: "", clientFilter: "", staffFilter: "Windsor Stagg", categoryFilter: "", sortBy: "quantity", limit: "40", columns: { item: true, quantity: true, revenue: true, cost: false, profit: true, margin: false, orders: true, date: false } },
    { name: "[WINDSOR] Slow-Moving Items (Low Quantity)", reportType: "item", startDate: "", endDate: "", itemFilter: "", clientFilter: "", staffFilter: "Windsor Stagg", categoryFilter: "", sortBy: "quantity", columns: { item: true, quantity: true, revenue: true, cost: true, profit: true, margin: true, orders: false, date: false } },
    { name: "[WINDSOR] Item Velocity (Revenue per Day - Last 90 Days)", reportType: "item", startDate: last90Days, endDate: "", itemFilter: "", clientFilter: "", staffFilter: "Windsor Stagg", categoryFilter: "", columns: { item: true, quantity: true, revenue: true, cost: false, profit: true, margin: false, orders: false, date: false } },
    { name: "[WINDSOR] Average Order Value Analysis", reportType: "order", startDate: "", endDate: "", itemFilter: "", clientFilter: "", staffFilter: "Windsor Stagg", categoryFilter: "", columns: { item: true, quantity: true, revenue: true, cost: true, profit: true, margin: true, orders: false, date: true } },

    // CLIENT BEHAVIOR & RELATIONSHIPS
    { name: "[WINDSOR] Repeat Customers", reportType: "client", startDate: "", endDate: "", itemFilter: "", clientFilter: "", staffFilter: "Windsor Stagg", categoryFilter: "", columns: { item: true, quantity: false, revenue: true, cost: true, profit: true, margin: true, orders: true, date: false } },
    { name: "[WINDSOR] New Customers (This Month)", reportType: "client", startDate: `${currentYear}-${currentMonth}-01`, endDate: "", itemFilter: "", clientFilter: "", staffFilter: "Windsor Stagg", categoryFilter: "", columns: { item: true, quantity: false, revenue: true, cost: false, profit: true, margin: false, orders: true, date: false } },
    { name: "[WINDSOR] Active Clients (Last 30 Days)", reportType: "client", startDate: last30Days, endDate: "", itemFilter: "", clientFilter: "", staffFilter: "Windsor Stagg", categoryFilter: "", columns: { item: true, quantity: false, revenue: true, cost: true, profit: true, margin: true, orders: true, date: false } },
    { name: "[WINDSOR] Dormant Clients (90+ Days No Orders)", reportType: "client", startDate: "", endDate: last90Days, itemFilter: "", clientFilter: "", staffFilter: "Windsor Stagg", categoryFilter: "", columns: { item: true, quantity: false, revenue: true, cost: false, profit: false, margin: false, orders: true, date: false } },
    { name: "[WINDSOR] Client Retention Analysis", reportType: "client", startDate: "", endDate: "", itemFilter: "", clientFilter: "", staffFilter: "Windsor Stagg", categoryFilter: "", columns: { item: true, quantity: false, revenue: true, cost: true, profit: true, margin: true, orders: true, date: false } },

    // ORDER SIZE ANALYSIS
    { name: "[WINDSOR] Large Orders (>$1000)", reportType: "order", startDate: "", endDate: "", itemFilter: "", clientFilter: "", staffFilter: "Windsor Stagg", categoryFilter: "", columns: { item: true, quantity: true, revenue: true, cost: true, profit: true, margin: true, orders: false, date: true } },
    { name: "[WINDSOR] Small Orders (<$100)", reportType: "order", startDate: "", endDate: "", itemFilter: "", clientFilter: "", staffFilter: "Windsor Stagg", categoryFilter: "", columns: { item: true, quantity: true, revenue: true, cost: true, profit: true, margin: true, orders: false, date: true } },
    { name: "[WINDSOR] Medium Orders ($100-$1000)", reportType: "order", startDate: "", endDate: "", itemFilter: "", clientFilter: "", staffFilter: "Windsor Stagg", categoryFilter: "", columns: { item: true, quantity: true, revenue: true, cost: true, profit: true, margin: true, orders: false, date: true } },
